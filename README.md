...
Terms & Privacy Policy Last updated: January 03, 2025
...
Additional Disclosures Tracking and Analytics Tools Yes, we use tracking and/or analytics tools, such as Google Analytics or other related tools, to analyze user behavior and improve our Service.

Tools Used for Tracking and Analytics:

Google Analytics Email Communications Yes, we send emails to users or users can opt-in to receive emails from us.

Platforms Used for Sending Emails:

Constant Contact Advertising Yes, we show ads to users.

Platforms Used for Showing Ads:

Google Ads (AdSense) Payment Processing Yes, users can pay for our products/services.

Payment Processors/Methods Used:

Apple Store In-App Payments Google Play In-App Payments Remarketing Services Yes, we use remarketing services to advertise our business.

Platforms Used for Remarketing:

Google Ads (AdWords) Twitter Facebook Bing Ads Pinterest AdRoll Perfect Audience AppNexus Contact Us If you have any questions about this Privacy Policy, You can contact us:

By visiting this page on our website: https://DietiAi.com
